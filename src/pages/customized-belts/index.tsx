...
import CustomProductCard from "../../component/pages/CustomProductCard/CustomProductCard";

const CustomziedBelts: React.FC = () => {
    ...
    <Layout>
      <div className="flex justify-center items-center">
        <div className="flex flex-col justify-center items-center w-11/12">
          <h1 className="text-center text-3xl font-bold m-4 py-4">Customized Belts</h1>
...
export default CustomziedBelts;
